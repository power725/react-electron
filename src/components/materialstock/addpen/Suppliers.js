        ...
        <React.Fragment>
            ...
            <div className="grid grid-cols-1  py-1 px-2 gap-x-6">
                <TableWrapper
                        showAdd={false}
                        headerText={
                            <button className="px-3 py-1 border border-blue-400 bg-gray-normal rounded text-sm text-left">
                        ...
                        <table className="min-w-full divide-y divide-gray-normal table-fixed">
                            <thead>
                                <tr className="text-left text-xs font-medium text-gray-darkest tracking-wider">
                                    ...
                                    <th className="p-2">Malzeme Kodu</th>
                            ...
                            <tbody className="divide-y divide-gray-200 text-sm text-gray-dark">
                                ...
                                <tr key={0}>
                                    ...
                                    <td className="p-2">
                                        <TableInput>
                                            <input className="cs-input" placeholder={"1,00"} />
                                        </TableInput>
                                    </td>
                                    <td className="p-2">

...
export default function ListCard(props) {
    ...
    return(
        <div className="p-3">
            <PageSubscribe text="Anasayfa > Üretim Modülü > İş İstasyonları"
                className="mb-5" />
            ...
            <div className={isFullScreen ? "full-screen" : ""}>
                <div className="flex justify-between items-center px-2 pb-1 border-b-2 border-gray-normal mb-2">
                    <h5 className="text-lg font-semibold text-gray-dark">Üretim İstasyonları Listesi</h5>
                ...
                <div className="flex">
                    ...
                    <div className="flex-grow">
                        <div className="rounded-lg border border-gray-normal bg-gray-lightest p-1 mb-2">
                            ...
                            {isAddBlockOpened &&
                                <AddCardBlock onClose={() => setAddBlockOpened(false)} />
                            }
                        </div>

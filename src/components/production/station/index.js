...
export default function ListStation(props) {
    ...
    return(
        <div className="p-3">
            <PageSubscribe text="Anasayfa > Üretim Modülü > İş İstasyonları Listesi"
                className="mb-5" />
            ...
            <div className={isFullScreen ? "full-screen" : ""}>
                <div className="flex justify-between items-center px-2 pb-1 border-b-2 border-gray-normal mb-2">
                    <h5 className="text-lg font-semibold text-gray-dark">İş İstasyonları Listesi</h5>
                    ...
                    <div className="flex-grow">
                        <div className="rounded-lg border border-gray-normal bg-gray-lightest p-1 mb-2">
                            <TableWrapper
                                showAdd={true}
                                headerText={
                                    <button className="px-3 py-1 border border-blue-400 bg-gray-normal rounded text-sm w-20 text-left" onClick={() => setAddBlockOpened(true)}>
                                ...
                                <table className="min-w-full divide-y divide-gray-normal table-fixed">
                                    <thead>
                                        <tr className="text-left text-xs font-medium text-gray-darkest tracking-wider">
                                            ...
                                            <th className="p-2">İstasyon Kodu</th>
                                            <th className="p-2">Adı</th>
                                            <th className="p-2">Açıklama</th>
                                            <th className="p-2">Günlük Çalışma</th>
                                            <th className="p-2">Kullanım Süresi</th>
                                            <th className="p-2">Yetkili</th>
                                            <th className="p-2">Giriş Deposu</th>
                                            <th className="p-2">Ürün Çıkış Deposu</th>
                                            <th className="p-2">Yan Ürün Çıkış Deposu</th>
                                            <th className="p-2">Fire Çıkış Deposu</th>
                                            <th className="p-2"></th>
                                        </tr>
                                    </thead>
                            ...
                            {isAddBlockOpened &&
                                <AddProductionBlock onClose={() => setAddBlockOpened(false)} />
                            }
                        </div>

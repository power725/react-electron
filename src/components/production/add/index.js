...
export default function AddMaterialStock(props) {
    ...
    return(
        <React.Fragment>
            <PageSubscribe text="Anasayfa > Üretim Modülü > Ürün Reçetesi Oluştur" />
            ...
            <div className={isFullScreen ? "full-screen" : ""}>
                ...
                <div className="flex justify-between items-center px-2 pb-2 border-b-2 border-gray-normal mb-2 mt-5">
                    <h5 className="text-lg font-semibold text-gray-dark">Ürün Reçetesi Oluştur</h5>
                ...
                <div className="rounded-lg bg-gray-lightest border border-gray-normal">
                    <div className="p-2 font-semibold text-base text-gray-dark">Reçete Bilgileri</div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 py-1 px-2 gap-x-6">
                        <div>
                            ...
                            <FormGroup label="Rota Kodu" icon={require('../../../images/icons/search.png')}>
                        ...
                        <div>
                            <FormGroup label="Özel Kod " icon={require('../../../images/icons/search.png')}>
                                <input className="cs-input pr-8" />
                            </FormGroup>
                            <FormGroup label="Durum" icon={require('../../../images/icons/angle-down.png')}>
                                <select className="cs-input appearance-none"></select>
                            </FormGroup>
                            <FormGroup label="Üst Reçete" icon={require('../../../images/icons/search.png')}>
                                <input className="cs-input pr-8" />
                            </FormGroup>
                        </div>

...
export default function PayrollList(props) {
    ...
    return(
        <div className="p-3">
            <PageSubscribe text="Anasayfa > Personel Modülü > Personel Puantaj Listesi"
                className="mb-5" />
            ...
            <div className={isFullScreen ? "full-screen" : ""}>
                <div className="flex justify-between items-center px-2 pb-1 border-b-2 border-gray-normal mb-2">
                    <h5 className="text-lg font-semibold text-gray-dark">Personel Puantaj Listesi</h5>
                        ...
                        <table className="min-w-full divide-y divide-gray-normal table-fixed">
                            <thead>
                                <tr className="text-left text-xs font-medium text-gray-darkest tracking-wider">
                                    ...
                                    <th className="p-2">Düz. Tarihi</th>
                                    <th className="p-2">Sicil No</th>
                                    <th className="p-2">Adı Soyadı</th>
                                    <th className="p-2">Şube</th>
                                    <th className="p-2">Yöntem</th>
                                    <th className="p-2">SSK Gün</th>
                                    <th className="p-2">Brüt Kazanç</th>
                                    <th className="p-2">Net Kazanç</th>
                                    <th className="p-2">İş  V. Maaliyeti</th>
                                    <th className="p-2">G.Vergisi</th>
                                    <th className="p-2">G.V. Matrahı</th>
                                    <th className="p-2">Cari Fiş No</th>
                                    <th className="p-2">Son Değiştiren</th>
                                    <th className="p-2"></th>
                                </tr>
                            </thead>
                ...
                <div className="flex justify-center">
                    ...
                    <button className="btn mx-1 px-6 bg-gray-normal border">Yazdır</button>
